...
class Erkek extends Command {
    ...
    // if(!member.user.username.includes("✬") && !message.member.hasPermission("MANAGE_ROLES")) return this.client.yolla("Şuanlık ✬ ewing adlı sunucuda taglı alım mevcuttur ( ✬ ) tagını alarak kayıt olabilirsin, bir süre sonra tagsız alıma geçildiğinde gelmeyi de tercih edebilirsin.", message.author, message.channel)
